        ...
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {quoteData.panelWattage && (
              <div>
                <p className="text-sm text-muted-foreground">Panel Wattage</p>
                <p className="text-lg font-semibold text-foreground">
            ...
            {quoteData.panelBrand && (
              <div>
                <p className="text-sm text-muted-foreground">Preferred Panel Brand</p>
                <p className="text-lg font-semibold text-foreground">
                  {quoteData.panelBrand}
                </p>
              </div>
        ...
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {quoteData.governmentIncentive && (
              <div>
                <p className="text-sm text-muted-foreground">Government Incentive</p>
        ...
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {quoteData.batteryCost && (
              <div>
                <p className="text-sm text-muted-foreground">Battery Cost</p>
                <p className="text-lg font-semibold text-foreground">
      ...
      {(quoteData.roofTilt || quoteData.panelOrientation || quoteData.shadingLevel) && (
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {quoteData.roofTilt && (
              <div>
                <p className="text-sm text-muted-foreground">Roof Tilt</p>
            ...
            {quoteData.panelOrientation && (
              <div>
                <p className="text-sm text-muted-foreground">Panel Orientation</p>
                <p className="text-lg font-semibold text-foreground capitalize">
                  {quoteData.panelOrientation}
                </p>
              </div>
            ...
            {quoteData.shadingLevel && (
              <div>
                <p className="text-sm text-muted-foreground">Shading Level</p>
                <p className="text-lg font-semibold text-foreground capitalize">
                  {quoteData.shadingLevel}
                </p>
              </div>
        ...
        <div className="rounded-lg border border-success bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {quoteData.co2OffsetAnnual && (
              <div>
                <p className="text-sm text-muted-foreground">CO₂ Offset (Annual)</p>
                <p className="text-lg font-semibold text-success">
        ...
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="flex flex-wrap gap-2">
            {quoteData.includeVPP && (
              <span className="px-3 py-1 bg-info text-info-foreground rounded-full text-sm font-medium">
                ✓ VPP Integration
              </span>
            )}
      ...
      {(quoteData.retailer || quoteData.tariffPlan) && (
        <div className="rounded-lg border border-border bg-surface shadow-neu-outset p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {quoteData.retailer && (
              <div>
                <p className="text-sm text-muted-foreground">Current Retailer</p>
                <p className="text-lg font-semibold text-foreground">
                  {quoteData.retailer}
                </p>
              </div>
            ...
            {quoteData.customRetailRate && (
              <div>
                <p className="text-sm text-muted-foreground">Retail Rate</p>
                <p className="text-lg font-semibold text-foreground">
