...
export interface Lead {
  ...
  unlockPrice: number; // For call_visit leads
  isUnlocked: boolean;
  unlockedBy: number[]; // Installer IDs who have unlocked
    ...
    <>
      ...
      <QuoteBuilderModal
        ...
        lead={{
          ...
          estimatedUsage: 'N/A', // Not available in Lead interface
          budget: lead.systemDetails.budget
        }}
...
const InstallerLeadFeed: React.FC<InstallerLeadFeedProps> = ({ 
  ...
  const mockLeads: Lead[] = [
    {
      ...
      type: 'call_visit',
      status: 'new',
      dateSubmitted: new Date(Date.now() - 2 * 60 * 60 * 1000), // 2 hours ago
    ...
    },
    {
      ...
      type: 'written',
      status: 'new',
      dateSubmitted: new Date(Date.now() - 5 * 60 * 60 * 1000), // 5 hours ago
    ...
    },
    {
      ...
      type: 'call_visit',
      status: 'unlocked',
      dateSubmitted: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000), // 1 day ago
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      // In real app, this would refetch leads
    }, 30000);
