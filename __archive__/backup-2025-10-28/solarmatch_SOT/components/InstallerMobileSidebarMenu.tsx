...
const InstallerMobileSidebarMenu: React.FC<InstallerMobileSidebarMenuProps> = ({ isOpen, onClose, activePage, setActivePage, onLogoutClick, unreadMessagesCount, newLeadsCount }) => {
        ...
        >
            ...
            >
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-xl font-bold text-slate-900 dark:text-white">Installer Menu</h2>
                ...
                <nav className="flex-grow flex flex-col items-center space-y-3">
                    ...
                    <NavItem icon={<ZapIcon />} title="Lead Feed" isActive={activePage === 'Lead Feed'} onClick={() => handleNavClick('Lead Feed')} badgeCount={newLeadsCount} />
                    <NavItem icon={<GavelIcon />} title="Active Bids" isActive={activePage === 'Active Bids'} onClick={() => handleNavClick('Active Bids')} />
                    ...
                    <NavItem icon={<BuildingIcon />} title="Company Profile" isActive={activePage === 'Company Profile'} onClick={() => handleNavClick('Company Profile')} />
                </nav>
