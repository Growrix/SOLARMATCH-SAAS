...
// Theme Switcher Component (copied from dashboard)
...
// AdminHeader Component (copied from dashboard)
...
export default function AdminLeadsPage() {
  ...
  return (
    <div className="homeowner-dashboard-bg min-h-screen text-slate-800 dark:text-slate-200">
