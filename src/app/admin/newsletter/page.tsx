...
// ============================================================================
// This page displays all newsletter subscribers in the admin dashboard.
// 
// TEACHING NOTE: This is a "client component" because it uses React hooks
// like useState and useEffect. The 'use client' directive tells Next.js to
// render this component on the client (browser), not the server.
//
// WHAT YOU'LL LEARN:
...
// - Using the project's theme system (dark mode)
...
// ICON COMPONENTS
// ============================================================================
// TEACHING NOTE: These are reusable SVG icons. Instead of importing icon
// libraries (which add weight to your app), we define icons as React
// components. This keeps the bundle size small and gives us full control.
// ============================================================================
