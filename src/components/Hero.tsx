...
const Hero: React.FC<HeroProps> = ({ onInstantQuoteClick, onRebateCalculatorClick }) => {
  return (
    <section id="hero" className="hero-section bg-background dark:bg-background relative overflow-hidden sm:min-h-[calc(100vh-80px)] flex items-center pt-8 sm:pt-24 pb-12 sm:pb-0">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-background p-4 sm:p-6 rounded-2xl shadow-neu-outset text-center transition-all duration-300 hover:shadow-neu-outset-lg" style={{ animation: 'fade-in-up 0.8s ease-out 0.6s both' }}>
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-background shadow-neu-inset flex items-center justify-center mx-auto mb-3 sm:mb-4 text-primary">
            ...
            <div className="bg-background p-4 sm:p-6 rounded-2xl shadow-neu-outset text-center transition-all duration-300 hover:shadow-neu-outset-lg" style={{ animation: 'fade-in-up 0.8s ease-out 0.8s both' }}>
              ...
              <div className="text-xs sm:text-sm text-muted-foreground">Free Service</div>
            </div>
