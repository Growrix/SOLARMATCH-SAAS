...
const FileTextIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-success"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/></svg>;
...
const QuoteOptionsModal: React.FC<QuoteOptionsModalProps> = ({ 
  ...
  <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div 
            className="bg-background p-6 rounded-2xl shadow-neu-outset hover:shadow-neu-outset-lg transition-all duration-300 cursor-pointer"
          ...
          >
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Call/Visit Quote</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Written Quote</h3>
            <p className="text-muted-foreground mb-6">
