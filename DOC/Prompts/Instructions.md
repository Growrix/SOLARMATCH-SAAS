...
Push the changes to the remote repository:
    git push origin your-branch-name:callvisitleads

Take a database backup (PostgreSQL in Docker):
    docker exec -t solarmatch-db-1 pg_dump -U postgres -F c -b -v -f /var/lib/postgresql/data/solarmatch-backup-YYYY-MM-DD.dump postgres
    docker cp solarmatch-db-1:/var/lib/postgresql/data/solarmatch-backup-YYYY-MM-DD.dump ./solarmatch-backup-YYYY-MM-DD.dump
